...
class AskChatbotSignUp extends React.Component {
    ...
    const Welcome = [
      {
        // welcome
        id: "getUserId",
        message: "please create your user id",
      ...
      },
      {
        ...
        user: true,
        inputType: "password",
        trigger: "getUserPasswordSecond"
      },
      { id: "getUserPasswordSecond",
      message: "please input your password again!",
      trigger: "getUserPasswordSecondInput"
    },
    {
      // on.FILLED
      id: "getUserPasswordSecondInput",
      user: true,
      inputType: "password",
      trigger: "signUp"
    },

      {
        ...
        message  : ( {previouis, steps } ) => {
          if ( this.toggleSignUp( steps.getUserIdInput.value, steps.getUserPasswordInput.value) )
          {   
...
export default AskChatbotSignUp;
